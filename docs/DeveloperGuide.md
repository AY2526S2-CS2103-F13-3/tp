...
Gemini (AI tool): Used by Tan Min Zhe for the implementation and troubleshooting of the HistoryCommand,  HistoryCommandParser classes and its test cases.
--------------------------------------------------------------------------------------------------------------------
...
**`Main`** (consisting of classes [`Main`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/java/seedu/address/Main.java) and [`MainApp`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/java/seedu/address/MainApp.java)) is in charge of the app launch and shut down.
...
The **API** of this component is specified in [`Ui.java`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/java/seedu/address/ui/Ui.java)

<puml src="diagrams/UiClassDiagram.puml" alt="Structure of the UI Component"/>

The UI consists of a `MainWindow` that is made up of parts e.g.`CommandBox`, `ResultDisplay`, `PersonListPanel`, `StatusBarFooter` etc. All these, including the `MainWindow`, inherit from the abstract `UiPart` class which captures the commonalities between classes that represent parts of the visible GUI.

The `UI` component uses the JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files that are in the `src/main/resources/view` folder. For example, the layout of the [`MainWindow`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/java/seedu/address/ui/MainWindow.java) is specified in [`MainWindow.fxml`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/resources/view/MainWindow.fxml)
...
**API** : [`Logic.java`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/java/seedu/address/logic/Logic.java)
...
### Model component
**API** : [`Model.java`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/java/seedu/address/model/Model.java)
...
<puml src="diagrams/MaintenanceTaskClassDiagram.puml" width="260" />
...
**API** : [`Storage.java`](https://github.com/AY2526S2-CS2103-F13-3/tp/blob/master/src/main/java/seedu/address/storage/Storage.java)
...
1. **Missing data file**
    1. Delete `data/addressbook.json` and `data/tasklist.json` and restart the app.
