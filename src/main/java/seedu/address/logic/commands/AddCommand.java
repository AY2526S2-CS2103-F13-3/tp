...
public class AddCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Adds a contractor to the EstateContacts. "
            + "Parameters: "
            + PREFIX_NAME + "NAME "
            + PREFIX_PHONE + "PHONE "
            + PREFIX_EMAIL + "EMAIL "
            ...
            + PREFIX_SERVICE + "Electrician";

    public static final String MESSAGE_SUCCESS = "Contractor added successfully.";
